module attributes {hacc.target = #hacc.target<"Ascend950PR_9579">} {
  func.func @test_gm_alias_rejected(%gmArg: memref<16x16xf16>, %input1: memref<16x16xf16>, %input2: memref<16x16xf16>) attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.func_core_type = #hivm.func_core_type<MIX>, mix_mode = "mix"} {
