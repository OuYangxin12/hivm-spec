module attributes {hacc.target = #hacc.target<"Ascend950PR_9579">} {
  func.func @test_pipeline_nd2nz_cross_workitem(%arg0: memref<?xi8> {hacc.arg_type = #hacc.arg_type<workspace>}, %gm_dst: memref<16x16xf16>, %v_src: memref<16x16xf16>, %k_src: memref<16x16xf16>) attributes {WorkspaceArgIdx = 0 : i16, func_dyn_memref_args = dense<[true, true]> : vector<2xi1>, global_kernel = "local", hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.func_core_type = #hivm.func_core_type<MIX>, mix_mode = "mix"} {
    %A = tensor.empty() : tensor<16x16xf16>
    // harvested-away: v_src 提升为函数参数
