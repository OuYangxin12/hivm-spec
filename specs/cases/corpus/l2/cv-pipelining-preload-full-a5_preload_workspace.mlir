module attributes {hacc.target = #hacc.target<"Ascend950PR_9579">} {
  func.func @a5_preload_workspace(%arg0: memref<?xi8> {hacc.arg_type = #hacc.arg_type<workspace>}, %a_mem: memref<16x16xf16>, %k_mem: memref<16x16xf16>) attributes {WorkspaceArgIdx = 0 : i16, func_dyn_memref_args = dense<[true]> : vector<1xi1>, global_kernel = "local", hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.func_core_type = #hivm.func_core_type<MIX>, mix_mode = "mix"} {
    // harvested-away: a_mem 提升为函数参数
    %a = bufferization.to_tensor %a_mem : memref<16x16xf16>
    // harvested-away: k_mem 提升为函数参数
